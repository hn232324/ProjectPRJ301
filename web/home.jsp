                    ...
                    <div class="modal-body">
                        <form action="" method="get">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" name="phone" class="form-control col-md-9" id="txtsdt" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control col-md-9" id="txtsum"  value="0">
                                </div>
                            </div>
                            <div style="display: flex; justify-content: center; align-items: center;">
                                <button type="submit" class="mr-1 btn btn-success"><i class="bi bi-plus-circle"></i> Thêm mới</button></div>
